  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        padding: EdgeInsets.only(top: AppLayout.getHeight(30), bottom: AppLayout.getHeight(25), left: AppLayout.getWidth(20), right: AppLayout.getWidth(20)),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.only(
        ...
        child: Row(
          ...
          children: [
            Container(
              padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(17), vertical: AppLayout.getHeight(12)),
              decoration: BoxDecoration(
